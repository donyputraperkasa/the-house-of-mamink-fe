        ...
        >
            ...
            <nav className={`flex-1 ${isCollapsed ? 'px-2' : 'px-4'} py-6 ${isCollapsed ? 'space-y-4' : 'space-y-2'}`}>
                <Link
                    ...
                    className={`flex items-center ${isCollapsed ? 'justify-center py-4' : 'gap-3 px-4 py-3'} mb-4 rounded-xl border border-gray-200 bg-white text-gray-600 hover:bg-amber-50 hover:text-amber-700 shadow-sm transition`}
                    onClick={() => setIsOpen(false)}
                >
